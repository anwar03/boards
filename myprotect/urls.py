...
urlpatterns = [
    ...
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/post/(?P<post_pk>\d+)/edit/$', views.PostUpdateView.as_view(), name='edit_post'),
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/reply/$', views.ReplyTopic.as_view(), name='reply_topic'),
